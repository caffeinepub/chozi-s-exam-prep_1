...
const ECZ_DATES = {
  "9": /* @__PURE__ */ new Date("2026-11-18T00:00:00"),
  "12": /* @__PURE__ */ new Date("2026-10-27T00:00:00")
};
const ECZ_DATE_LABELS = {
  "9": "18 November 2026",
  "12": "27 October 2026"
};
const SUBJECTS = [
  {
    ...
    questions: {
      ...
      g12: [
        ...
        {
          question: "Freedom of association is enshrined in which part of the constitution?",
  ...
  },
  {
    ...
    questions: {
      ...
      g12: [
        {
          question: "The Scramble for Africa took place mainly in which century?",
        ...
        {
          question: "The Federation of Rhodesia and Nyasaland was dissolved in?",
...
function saveScore(subjectId, grade, score) {
...
function Confetti({ onDone }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 pointer-events-none z-[9999] overflow-hidden", children: particles.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
...
function ProgressRing({
  ...
  const [displayed, setDisplayed] = reactExports.useState(animated ? 0 : percentage);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative inline-flex items-center justify-center", children: [
      ...
      "svg",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: gradId, x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: colors.from }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: colors.to })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "circle",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex flex-col items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "span",
      {
...
function useCountdown(target) {
  const calc = reactExports.useCallback(() => {
...
function CountdownCard({ grade }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-glass rounded-2xl p-6", "data-ocid": "countdown.card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-4 w-4 text-gold" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest text-gold font-semibold", children: "Countdown" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-lg font-bold text-foreground mb-1", children: [
      "ECZ Grade ",
      grade,
      " Exams Begin In"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-lavender mb-5", children: [
      "Starting ",
      ECZ_DATE_LABELS[grade]
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-2", children: segments.map((seg) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "countdown-segment", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-bold gold-gradient-text leading-none", children: String(seg.value).padStart(2, "0") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-lavender uppercase tracking-wider mt-1", children: seg.label })
    ] }, seg.label)) })
  ] });
}
function QuizModal({
  ...
  const questions = subject.questions[`g${grade}`];
  ...
  const finalScore = answers.filter(
    (a, i) => {
      var _a2;
      return a === ((_a2 = questions[i]) == null ? void 0 : _a2.correct);
    }
  ).length;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (o) => !o && handleClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DialogContent,
    {
      ...
      children: [
        ...
        !showResult ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-lavender", children: [
              "Question ",
              current + 1,
              " of ",
              questions.length
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-1.5 rounded-full bg-purple-mid", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-semibold text-foreground mb-4 leading-snug", children: q.question }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 mb-6", children: q.options.map((opt, optIdx) => {
            let cls = "w-full text-left px-4 py-3 rounded-xl border text-sm font-medium transition-all duration-200 ";
            if (!submitted) {
              cls += selected === optIdx ? "border-gold bg-gold/10 text-gold" : "border-border bg-muted/30 text-foreground hover:border-purple-light hover:bg-purple-mid/20";
            } else {
              if (optIdx === q.correct)
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-6 h-6 rounded-full border border-current mr-2 text-center text-xs leading-6", children: OPTION_LETTERS[optIdx] }),
                  opt
                ]
              },
              opt
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `text-3xl font-bold mb-1 ${finalPct >= 80 ? "text-emerald-400" : finalPct >= 50 ? "text-gold" : "text-red-400"}`,
              children: [
                finalScore,
                "/",
                questions.length,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-lavender mb-2", children: [
            finalPct,
            "% Score"
          ] }),
          finalPct >= 80 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-1 bg-emerald-500/20 text-emerald-300 text-sm px-3 py-1 rounded-full mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "h-3.5 w-3.5" }),
            " Excellent! You passed with distinction!"
          ] }) : finalPct >= 50 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-1 bg-gold/20 text-gold text-sm px-3 py-1 rounded-full mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "h-3.5 w-3.5" }),
            " Good effort — keep practising!"
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center gap-1 bg-red-500/20 text-red-300 text-sm px-3 py-1 rounded-full mb-4", children: "Keep studying — you can do it!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              onClick: handleClose,
...
function QuizCard({ subject, grade, bestScore, onStart }) {
  const difficulty = grade === "9" ? "Easy" : subject.id === "math" || subject.id === "history" ? "Hard" : "Medium";
  const diffColor = difficulty === "Easy" ? "text-emerald-400" : difficulty === "Medium" ? "text-gold" : "text-red-400";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold text-foreground leading-tight", children: subject.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-lavender mt-0.5", children: "10 Questions • 15 mins" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-lavender", children: [
            "Best:",
            " ",
            bestScore !== void 0 ? `${bestScore}%` : "Not attempted yet"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
...
function ContinueLearningModal({
  ...
  var _a2;
  const textbook = (_a2 = TEXTBOOKS[grade]) == null ? void 0 : _a2[subject.id];
  const pct = grade === "9" ? subject.g9Percent : subject.g12Percent;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (o) => !o && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "card-glass border-border max-w-md mx-auto max-h-[90vh] overflow-y-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "text-gold text-lg font-bold flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-5 h-5 text-purple-bright" }),
      "Continue Learning"
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0",
            style: { background: subject.color },
            children: subject.name.charAt(0)
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-semibold text-sm", children: subject.name }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs uppercase tracking-widest text-gold font-bold mb-3", children: "Study Tips" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: [
          ...
          "li",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3.5 h-3.5 text-purple-bright mt-0.5 flex-shrink-0" }),
              tip
            ]
          },
          tip
      ...
      textbook && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs uppercase tracking-widest text-gold font-bold mb-3", children: "📚 Official ECZ Textbook" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 items-start p-3 rounded-xl bg-white/5 border border-border hover:border-purple-light transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: textbook.cover,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground text-sm font-semibold leading-snug", children: textbook.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "w-fit text-[10px] bg-emerald-500/20 text-emerald-300 border-emerald-500/30", children: "✓ ECZ Approved" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-xs", children: [
              "Official curriculum textbook for Grade ",
              grade
            ] })
          ] })
        ] })
      ...
      !textbook && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs uppercase tracking-widest text-gold font-bold mb-3", children: "📚 Official ECZ Textbook" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 rounded-xl bg-white/5 border border-border text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs", children: "Textbook information coming soon for this subject." }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
...
function App() {
  const [grade, setGrade] = reactExports.useState("9");
  const [mobileMenuOpen, setMobileMenuOpen] = reactExports.useState(false);
  const [activeQuiz, setActiveQuiz] = reactExports.useState(null);
  const [scores, setScores] = reactExports.useState(loadScores);
  const [attempts, setAttempts] = reactExports.useState(loadAttempts);
  ...
  const handleQuizComplete = (score, total) => {
    ...
    const attempt = {
      ...
      grade,
      score: pct,
      date: (/* @__PURE__ */ new Date()).toLocaleDateString("en-ZM", {
        day: "numeric",
        month: "short",
        year: "numeric"
      })
  ...
  const gradeScoreKeys = Object.keys(scores).filter(
    (k) => k.endsWith(`_${grade}`)
  );
  const bestOverall = gradeScoreKeys.length > 0 ? Math.max(...gradeScoreKeys.map((k) => scores[k])) : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen gradient-bg font-sans", children: [
    showConfetti && /* @__PURE__ */ jsxRuntimeExports.jsx(Confetti, { onDone: () => setShowConfetti(false) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 card-glass border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-purple flex items-center justify-center shadow-glow flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "h-6 w-6 text-gold" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold gold-gradient-text leading-tight", children: "Chozi's Exam Prep" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-purple-bright uppercase tracking-widest font-semibold", children: "Study Smart. Score High." })
          ] })
        ] }),
      ...
      mobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden border-t border-border px-4 py-3 space-y-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mb-10 animate-slide-up", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-2 gap-8 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "mb-4 bg-purple/20 text-purple-bright border-purple/40 text-xs uppercase tracking-wider", children: "🇿🇲 ECZ Official Syllabus 2026" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-4", children: [
            "Master Your",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gold-gradient-text", children: "ECZ Exams!" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-lavender mb-6 leading-relaxed", children: "Premium Grade 9 & 12 exam preparation with interactive quizzes, progress tracking, and Zambia-specific curriculum." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: "View Subjects"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-6 mt-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold gold-gradient-text", children: stat.value }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-lavender", children: stat.label })
          ] }, stat.label)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center lg:justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-glass rounded-3xl p-8 text-center shadow-glow", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-widest text-lavender mb-3", children: "Your Overall Progress" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ProgressRing,
            {
              subjectId: "biology",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 text-sm text-lavender", children: [
            "Across all subjects · Grade ",
            grade
          ] })
        ] }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mb-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-lavender font-medium", children: "Select Grade:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: ["9", "12"].map((g) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            onClick: () => handleGradeChange(g),
            className: `px-6 py-2 rounded-full text-sm font-bold transition-all duration-300 ${grade === g ? "bg-purple text-foreground shadow-glow" : "border border-purple-mid text-lavender hover:border-purple hover:text-foreground"}`,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "grid md:grid-cols-2 gap-6 mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CountdownCard, { grade }, grade),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-glass rounded-2xl p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "h-4 w-4 text-gold" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs uppercase tracking-widest text-gold font-semibold", children: [
              "Grade ",
              grade,
              " Quick Stats"
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: [
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold gold-gradient-text", children: stat.value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-lavender", children: stat.label })
              ]
            },
            stat.label
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "subjects-section", className: "mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest text-gold font-bold px-3", children: "Subject Progress Trackers" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4", children: SUBJECTS.map((subject) => {
          const pct = grade === "9" ? subject.g9Percent : subject.g12Percent;
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  `${subject.id}-${grade}-${animKey}`
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold text-foreground mt-3 leading-tight", children: subject.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    className: `mt-2 text-[10px] px-2 py-0 ${mastered ? "bg-emerald-500/20 text-emerald-300 border-emerald-500/30" : "bg-gold/20 text-gold border-gold/30"}`,
                    children: mastered ? "✓ Mastered" : "In Progress"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest text-gold font-bold px-3", children: "Practice Quizzes" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4", children: SUBJECTS.slice(0, 3).map((subject) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          QuizCard,
          {
            subject,
            grade,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 gap-4", children: SUBJECTS.slice(3).map((subject) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          QuizCard,
          {
            subject,
            grade,
      ...
      attempts.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest text-gold font-bold px-3", children: "Recent Quiz Attempts" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left text-xs uppercase tracking-wider text-lavender font-semibold", children: "Subject" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left text-xs uppercase tracking-wider text-lavender font-semibold", children: "Grade" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left text-xs uppercase tracking-wider text-lavender font-semibold", children: "Score" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-left text-xs uppercase tracking-wider text-lavender font-semibold", children: "Date" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: attempts.slice(0, 6).map((a, rowIdx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "tr",
                {
                  className: "border-b border-border/50 hover:bg-purple-mid/10 transition-colors",
                  "data-ocid": `attempts.item.${rowIdx + 1}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-medium text-foreground", children: a.subject }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-4 py-3 text-lavender", children: [
                      "Grade ",
                      a.grade
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                      {
                        className: `font-bold ${a.score >= 80 ? "text-emerald-400" : a.score >= 50 ? "text-gold" : "text-red-400"}`,
                        children: [
                          a.score,
                          "%"
                        ]
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-lavender text-xs", children: a.date })
                  ]
                },
                `${a.subject}-${a.grade}-${a.date}-${rowIdx}`
              )) })
            ] }) })
          }
        )
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-semibold text-foreground mb-1", children: "No quizzes attempted yet" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-lavender", children: "Take your first quiz above to track your progress!" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:col-span-2 lg:col-span-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl bg-purple flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { className: "h-5 w-5 text-gold" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base font-bold gold-gradient-text", children: "Chozi's Exam Prep" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-lavender leading-relaxed", children: "Built for Zambian Students · ECZ Exam Success" })
        ] }),
        [
          {
            title: "Resources",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs uppercase tracking-widest text-gold font-bold mb-3", children: col.title }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-lavender", children: [
          "© ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3", children: SOCIAL_ICONS.map(({ name, Icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
    ...
    activeQuiz && /* @__PURE__ */ jsxRuntimeExports.jsx(
      QuizModal,
      {
        subject: activeQuiz,
        grade,
